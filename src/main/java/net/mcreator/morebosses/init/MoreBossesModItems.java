...
import net.mcreator.morebosses.item.PhoenixsummonerItem;
...
public class MoreBossesModItems {
	...
	public static final RegistryObject<Item> PHOENIXSUMMONER = REGISTRY.register("phoenixsummoner", () -> new PhoenixsummonerItem());
}
