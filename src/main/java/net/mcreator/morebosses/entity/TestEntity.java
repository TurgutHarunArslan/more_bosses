...
import net.mcreator.morebosses.procedures.TestProjectileHitsBlockProcedure;
...
public class TestEntity extends AbstractArrow implements ItemSupplier {
	public TestEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(MoreBossesModEntities.TEST.get(), world);
	}
	...
	public ItemStack getItem() {
		return new ItemStack(MoreBossesModItems.TEST.get());
	}
	...
	public void onHitBlock(BlockHitResult blockHitResult) {
		...
		TestProjectileHitsBlockProcedure.execute(this.level, blockHitResult.getBlockPos().getX(), blockHitResult.getBlockPos().getY(), blockHitResult.getBlockPos().getZ());
	}
	...
	public static TestEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		TestEntity entityarrow = new TestEntity(MoreBossesModEntities.TEST.get(), entity, world);
	...
	public static TestEntity shoot(LivingEntity entity, LivingEntity target) {
		TestEntity entityarrow = new TestEntity(MoreBossesModEntities.TEST.get(), entity, entity.level);
