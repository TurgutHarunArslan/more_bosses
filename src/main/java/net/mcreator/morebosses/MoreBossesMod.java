...
@Mod("more_bosses")
public class MoreBossesMod {
	public static final Logger LOGGER = LogManager.getLogger(MoreBossesMod.class);
	public static final String MODID = "more_bosses";

	public MoreBossesMod() {
		MinecraftForge.EVENT_BUS.register(this);
		MoreBossesModTabs.load();
